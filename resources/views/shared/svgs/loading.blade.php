<svg width="200px"  height="200px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="lds-cube" style="background: none;">
  <g transform="translate(25,25)">
    <rect x="-20" y="-20" width="40" height="40" fill="#fff" transform="scale(1.01424 1.01424)">
  ...
  <g transform="translate(75,25)">
    <rect x="-20" y="-20" width="40" height="40" fill="#000" transform="scale(1.02402 1.02402)">
  ...
  <g transform="translate(25,75)">
    <rect x="-20" y="-20" width="40" height="40" fill="#000" transform="scale(1.05234 1.05234)">
    <animateTransform attributeName="transform" type="scale" calcMode="spline" values="1.2;1" keyTimes="0;1" dur="1s" keySplines="0 0.5 0.5 1" begin="0s" repeatCount="indefinite">
    </animateTransform></rect></g>
  <g transform="translate(75,75)">
    <rect x="-20" y="-20" width="40" height="40" fill="#fff" transform="scale(1.03659 1.03659)">
